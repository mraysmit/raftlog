...
### 7. Metrics, tracing, compression, and encryption

RaftLog emits operational logs but does not expose stable metrics or tracing hooks, and it does not provide compression or application-level encryption at rest.
...
- Authoritative indexing or checkpoint metadata
